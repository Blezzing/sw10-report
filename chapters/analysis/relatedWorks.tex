...
To give a demonstration of the libraries, and their programming model, an implementation of the SAXPY computation is presented for each. We chose SAXPY due to its relative simplicity and parellel nature.
...
From line \ref{code:boltSaxpy:opencl} it is shown how, instead of a lambda, a functor is needed. The functor is then defined inside a BOLT_FUNCTOR macro to statically generate relevant OpenCL code.
