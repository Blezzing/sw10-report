The design of the framework, including API and architecture, is described in this chapter. Thought processes behind decisions are included to reason about choices when multiple options are present.
