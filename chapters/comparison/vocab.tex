...
\begin{description}
    ...
    Describes the closeness of the systems representation to the domain it models. In the context if this comparison, it describes how the system relates and maps to working directly with \textit{CUDA} or \textit{OpenCL}.  
    ...
    Describes the degree of verbosity of the system. This includes the display space needed to express functionality.
